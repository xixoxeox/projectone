...
export function WatchlistDashboard() {
  ...
  return <main className="watchlist-shell"><nav aria-label="주요 메뉴"><a href="/dashboard">대시보드</a> · <a href="/screener">스크리너</a> · <a href="/analysis">종목 분석</a></nav><header className="watchlist-header"><p className="eyebrow">KOSPI SWING WATCHLIST</p><h1>관심 종목</h1><p>순위와 경고를 빠르게 확인하세요.</p></header>
